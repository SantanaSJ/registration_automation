Feature: Register functionality
  ...
  Background:
    Given I am on register page "https://transfermate.io/en/register.asp?"
  ...
  Scenario Outline: Successful registration for an online private company business account
    ...
    Then the page is redirected to Email and mobile verification page "https://www.transfermate.io/en/register_mail_verification.html?frwd_frb_country=0" with heading "Please check your mail"
...
#    And I enter the captcha result
#    And I click Register button
#    Then the page is redirected to Email and mobile verification page "https://www.transfermate.io/en/register_mail_verification.html?frwd_frb_country=1" with error heading
#
#    Examples:
#      | account type     | sub type        | iterate |
#      | Business Account | Private Company | 1       |
